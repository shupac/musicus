define(function(require, exports, module) {
    ...
    FamousMatrix.interpret = function(M) {
        ...
        var x_norm = norm(x);                       // norm of first column vector
        var v = [x[0] + sgn * x_norm, x[1], x[2]];  // v = x + sign(x[0])|x|e1
        ...
        var x2_norm = norm(x2);                              // norm of first column vector
        var v2 = [x2[0] + sgn2 * x2_norm, x2[1]];            // v = x + sign(x[0])|x|e1
