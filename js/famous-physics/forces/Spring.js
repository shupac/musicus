define(function(require, exports, module) {
    ...
    Spring.prototype.setOpts = function(opts){
	    ...
	    if (opts.bodyAnchor !== undefined){
            if (opts.bodyAnchor   instanceof Vector)  this.opts.bodyAnchor = opts.bodyAnchor;
            if (opts.bodyAnchor   instanceof Array)  this.opts.bodyAnchor = new Vector(opts.bodyAnchor);
        }
